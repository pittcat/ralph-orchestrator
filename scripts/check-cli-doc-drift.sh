...
declare -A COMMANDS_TO_DOCS=(
  ...
  ["tools workstate set"]="ralph-tools-workstate.md|Workstate Commands"
  ["tools workstate get"]="ralph-tools-workstate.md|Workstate Commands"
  ["tools workstate list"]="ralph-tools-workstate.md|Workstate Commands"
  ["tools workstate delete"]="ralph-tools-workstate.md|Workstate Commands"
