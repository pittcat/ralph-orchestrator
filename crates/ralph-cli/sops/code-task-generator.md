...
List generated files with paths. For PDD mode, include the step's demo requirements. Suggest running `ce-executor-isolated` on tasks in sequence, or using Ralph for autonomous implementation.
