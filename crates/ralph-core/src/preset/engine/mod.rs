...
pub use gates::{GateContext, GateDecision, run_gates};
pub use hint::{LintFailureClass, LintResumeHint, classify_lint_failure};
pub use lint_mirror::{build_lint_mirror_block, build_lint_resume_block};
pub use linter::{LintOutcome, auto_handoff_prepare, lint_emit};
