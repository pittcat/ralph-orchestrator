#!/usr/bin/env python3
"""Fake ralph binary for the unsafe-mock fixture.

This fixture is exercised via ``UnsafeBackend(kind="mock")``. The
...
def main() -> int:
    ...
    if transcript_dir:
        ...
        with open(
            ...
            handle.write("unsafe-mock: harness spawned when it should not have\n")
    return 0
