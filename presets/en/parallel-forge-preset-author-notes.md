...
- **仍属后续收口**：BDD×9、真实 authoritative DAG canary/crash matrix，以及 `dag_pools` 与 `max_concurrent_workers` 的单一容量权威收敛仍待处理。author/review skill references、mock E2E 与 PMI-004/TG-S13 的 process-group 清理已完成。
